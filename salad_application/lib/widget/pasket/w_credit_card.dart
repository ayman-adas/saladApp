...
class WidgetCreditCard extends StatefulWidget {
  const WidgetCreditCard({super.key});

  @override
  State<StatefulWidget> createState() => WidgetCreditCardState();
}

class WidgetCreditCardState extends State<WidgetCreditCard> {
  String cardNumber = '';
  String expiryDate = '';
  ...
  Widget build(BuildContext context) {
    bool isLightTheme = !DarkLightTheme.isDark(context);
  ...
  void _onValidate() {
    if (formKey.currentState?.validate() ?? false) {
      ...
      if (context.mounted) {
        ...
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => const VSalad()));
      }
    } else {
      // print('invalid!');
    }
