/// [MLanguages] for translate in english show englist in arabic show arabic
...
class MLanguages {
  ...
  static const String page1errorMassage = "page1 errorMassage";
  static const String page2title = "page2 title";
  static const String page2button = "page2 button";
  static const String page2errorMassage = "page2 errorMassage";
  static const String page2hint = "page2 hint";
  ...
  static const String strawbery = "strawbery";
