...
//   List<MFruitSalad> listview(BuildContext context) {
//     CFruitsalad controllerFruitUpload =
//         Provider.of<CFruitsalad>(context, listen: false);
//     List<MFruitSalad> list = [];
//     final Future<List<MFruitSalad>> getAllsalad =
//         controllerFruitUpload.categoryList();
//     getAllsalad.then((value) {
...
//   void changeCounter(int index, int counter, BuildContext context) {
//     List<MFruitSalad> list = listview(context);
//     list[index].setCount(counter);
//     notifyListeners();
//   }
